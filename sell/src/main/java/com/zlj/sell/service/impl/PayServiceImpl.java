...
import com.zlj.sell.utils.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse create(OrderDTO orderDTO) {
        ...
        log.info("[微信订单支付] 发起支付 payRequest={}", JsonUtil.toJson(payRequest));

        PayResponse payResponse = bestPayService.pay(payRequest);
        log.info("[微信订单支付] 发起支付 payResponse={}", JsonUtil.toJson(payResponse));
        return payResponse;
    }
}
